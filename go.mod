module github.com/dotdak/exchange-system
...
require (
	...
	github.com/testcontainers/testcontainers-go/modules/compose v0.21.0 // indirect
	github.com/testcontainers/testcontainers-go/modules/mysql v0.21.0 // indirect
