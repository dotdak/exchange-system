...
const (
	BuyService_Buy_FullMethodName = "/v1.BuyService/Buy"
)
...
func (c *buyServiceClient) Buy(ctx context.Context, in *BuyRequest, opts ...grpc.CallOption) (*BuyResponse, error) {
	out := new(BuyResponse)
	err := c.cc.Invoke(ctx, BuyService_Buy_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func RegisterBuyServiceServer(s grpc.ServiceRegistrar, srv BuyServiceServer) {
	s.RegisterService(&BuyService_ServiceDesc, srv)
}
...
func _BuyService_Buy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BuyService_Buy_FullMethodName,
	}
...
// BuyService_ServiceDesc is the grpc.ServiceDesc for BuyService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var BuyService_ServiceDesc = grpc.ServiceDesc{
